...
headlabel = tk.Label(Tops,font=('lato blue', 19,'bold'), text = '      Final Project   :    Currency Converter  ', bg= 'deep sky blue',fg='white') 
...
CurrenyCode_list = ["INR", "USD", "CAD", "CNY", "DKK", "EUR","BTC","DOGE","ETH","Euro"]
...
Label_9 =Button(root, font=('arial', 15,'bold'), text="   Convert  ",padx=2,pady=2, bg="green",fg = "white",command=RealTimeCurrencyConversion)
Label_9.grid(row=6, column=1)

Label_1 =Label(root, font=('lato black', 7,'bold'), text="",padx=2,pady=2, bg="#e6e5e5",fg ="black")
Label_1.grid(row=9, column=0,sticky=W)

Label_9 =Button(root, font=('arial', 15,'bold'), text="   Clear All  ",padx=2,pady=2, bg="red",fg = "white",command=clear_all)
Label_9.grid(row=10, column=1)

Label_9 =Button(root, font=('arial', 15,'bold'), text="   Toki Adeosun  ",padx=2,pady=2, bg="deep sky blue",fg = "white",command=clear_all)
